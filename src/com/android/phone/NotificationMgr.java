...
public class NotificationMgr {
        ...
        protected void onQueryComplete(int token, Object cookie, Cursor cursor) {
            ...
            case CONTACT_TOKEN:
                ...
                if ((cursor != null) && (cookie != null)) {
                    ...
                    String voiceNumber = GeminiUtils.getVoiceMailNumber(n.slotId);
                    Uri personUri = null;
                    if (cursor.moveToFirst()) {
                        if (!PhoneNumberUtils.compare(n.number, voiceNumber)) {
                            n.name = cursor.getString(cursor
                                    .getColumnIndexOrThrow(PhoneLookup.DISPLAY_NAME));
                        } else {
                            n.name = TelephonyManager.getDefault().getVoiceMailAlphaTag();
                        }
    ...
    /* package */void notifyMissedCall(String name, String number, String type, Drawable photo,
        ...
        int smallIconId = (1 == callVideo) ? R.drawable.mtk_ic_stat_notify_missed_call_video
...
//        }
    ...
    private int[] mCfiIconMap = {
            R.drawable.mtk_stat_sys_phone_call_forward_blue,
            R.drawable.mtk_stat_sys_phone_call_forward_orange,
            R.drawable.mtk_stat_sys_phone_call_forward_green,
            R.drawable.mtk_stat_sys_phone_call_forward_purple,
    ...
    public void showCipherIndicationNotification() {
        Notification notification = new Notification(
                R.drawable.mtk_ic_call_cipher_indication,  // icon
                null, // tickerText
                0);
        notification.setLatestEventInfo(
                mContext,  // context
