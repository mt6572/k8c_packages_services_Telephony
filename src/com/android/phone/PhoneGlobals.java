...
public class PhoneGlobals extends ContextWrapper implements WiredHeadsetListener {
    ...
    public void onCreate() {
        ...
        if (phone == null) {
            ...
            if (PhoneFactory.isLteDcSupport()){
                phoneMgrEx.setLteDcPhone(PhoneFactory.getLteDcPhone());
            }
            ...
            */
            ...
            /// M: add for tty mode registration
    ...
    */
    ...
    public void requestWakeState(WakeState ws) {
	  ...
	  if (VDBG) Log.d(LOG_TAG, "requestWakeState 2222" + getCallMode());
	 // if (PhoneGlobals.getInstance().getCallMode()==0)
        synchronized (this) {
            if ((mWakeState != ws)&&(getCallMode()==0)) {
                switch (ws) {
                    case PARTIAL:
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
             ...
             /// M: add for tty mode registration
                ...
                if(mTtyEnabled && !PhoneUtils.isOnAirplaneMode()){
                    mHandler.sendMessage(mHandler.obtainMessage(EVENT_TTY_PREFERRED_MODE_CHANGED, 0));
                }
