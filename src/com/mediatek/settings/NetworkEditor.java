...
public class NetworkEditor extends android.app.Activity 
    ...
    public class NetworkEditorFragment extends PreferenceFragment
        ...
        public boolean onPreferenceChange(Preference preference, Object objValue) {
            ...
            if (preference == mPriority) {
                int priority = 0;
                try {
                    priority = Integer.parseInt(/*String.valueOf(mPriority.getSummary())*/value);
                    PhoneLog.d(TAG, "onPreferenceChange()... priority: " + priority);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (menu != null) {
            ...
            if (getIntent().getBooleanExtra(PLMN_ADD, true)) {
                ...
                PhoneLog.d(TAG, "networkID: " + mNetworkId.getSummary()
                        + ", priority: " + mPriority.getSummary()
                ...
                boolean isSame = mInitNetworkId.equals(mNetworkId.getSummary())
                        ...
                        && mInitPrority.equals(mPriority.getSummary());
                menu.getItem(1).setEnabled(isShouldEnabled && !isSame && !isEmpty);
                /// @}
            }
        }
    ...
    private void updateNetWorkInfo(Intent intent) {
        ...
        if (TextUtils.isEmpty(mNetworkInfo.getNetworkId())) {
            ...
            PhoneLog.d(TAG, "mInitNetworkId: " + mInitNetworkId);
        ...
        if (mNetworkInfo.mPriority == -1) {
            mInitPrority  = String.valueOf(intent.getIntExtra(PLMN_PRIORITY, 0));
            PhoneLog.d(TAG, "mInitPrority: " + mInitPrority);
        ...
        if(TextUtils.isEmpty(mNetworkInfo.getNetWorkMode())) {
            ...
            mInitNetworkMode = getResources().getStringArray(R.array.plmn_prefer_network_type_choices)[act];
            PhoneLog.d(TAG, "mInitNetworkMode: " + mInitNetworkMode);
