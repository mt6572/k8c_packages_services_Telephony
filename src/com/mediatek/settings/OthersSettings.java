...
public class OthersSettings extends android.app.Activity { 
    ...
    public static class OthersSettingsFragment extends PreferenceFragment implements
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            /// Add for [ANC] @{
            activityRef.get().mButtonANC = (CheckBoxPreference)findPreference(BUTTON_ANC_KEY);
            if (!PhoneUtils.isANCSupport() ) {
                this.getPreferenceScreen().removePreference(activityRef.get().mButtonANC);
            }
            activityRef.get().mButtonANC.setOnPreferenceChangeListener(this);
            /// @}
        ...
        public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
         ...
         public boolean onPreferenceChange(Preference preference, Object objValue) {
             ...
             /// Add for [ANC] @{
             } else if (preference == activityRef.get().mButtonANC) {
                 if (activityRef.get().mButtonANC.isChecked()) {
                     PhoneLog.d(LOG_TAG, "onPreferenceChange mButtonANC turn on");
                     PhoneUtils.setANCEnable(true);
                     activityRef.get().mButtonANC.setSummary(R.string.anc_off);
                 } else {
                     PhoneLog.d(LOG_TAG, "onPreferenceChange mButtonANC turn off");
                     PhoneUtils.setANCEnable(false);
                     activityRef.get().mButtonANC.setSummary(R.string.anc_on);
                 }
             }
             /// @}
             return true;
