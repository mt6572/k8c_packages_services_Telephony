...
public class CellBroadcastActivity extends TimeConsumingPreferenceActivity {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.mtk_cell_broad_cast);
    ...
    private void enableScreen() {
        ...
        if (ps == null) {
            Log.w(LOG_TAG, "[enableScreen]retrieve PreferenceScreen failed, fail to set enable " + isShouldEnabled);
            return;
        }
        ps.setEnabled(isShouldEnabled);
    }
