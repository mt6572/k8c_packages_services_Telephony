...
public class VTManagerWrapper {
    ...
    /**
     * There exist a danger, VTManager.setVTClose() is async handled;
     * VTCallUtils.internalAnswerVTCallPre() will call setVTClose() and setVTOpen(),
     * when setVTOpen() comes here, maybe mVTManager.getState() has not been set as CLOSE yet.
     * maybe we should move those VTManager.state-related functions to the thread of mHandler to handle.
     * @param context
     * @param slotId
     */
     ...
     * But other functions called from CallCommandService runs in another thread;
    ...
    public void switchCamera() {
        ...
        (new Thread() {
            public void run() {
                log("VTManager.switchCamera() begin !");
    ...
    public void savePeerPhoto() {
        ...
        (new Thread() {
            public void run() {
                boolean ret = mVTManager.savePeerPhoto();
    ...
    public void setPeerView(int bEnableReplacePeerVideo,
        ...
        log("setPeerView()...bEnableReplacePeerVideo / sReplacePeerVideoPicturePath : "
    ...
    public void setLocalView(int videoType, String path) {
        log("setLocalView()...videoType / path : " + videoType + " / " + path);
