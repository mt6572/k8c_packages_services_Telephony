...
public class BlackListManager {
	...
	public int getBlockMode(int type) {
	   ...
	   // try {//lava del by liuweibo 20140328
			final int mode =  2;// pfl add : Settings.System.getInt(mContext.getContentResolver(), key);//lava modify by liuweibo 20140328
			return mode;
			
			//lava del start by liuweibo 20140328
		//} catch (SettingNotFoundException e) {
		//	  e.printStackTrace();
		//}
	
		//return OFF;
			//lava del end by liuweibo 20140328
	}
